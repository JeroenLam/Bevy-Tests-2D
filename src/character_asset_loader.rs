...
fn load_assets(
    ...
    player_animation_assets.map.insert(AnimationType::Jump, (
            texture_atlas_layouts.add(run_atlas_layout), 
            run_texture, 
    ...
    player_animation_assets.map.insert(AnimationType::Fall, (
            texture_atlas_layouts.add(run_atlas_layout), 
            run_texture, 
            AnimationIndices::new(0, 0)
        ));
    ...
    player_animation_assets.map.insert(AnimationType::WallJump, (
            texture_atlas_layouts.add(run_atlas_layout), 
            run_texture, 
    ...
    player_animation_assets.map.insert(AnimationType::DoubleJump, (
            texture_atlas_layouts.add(run_atlas_layout), 
            run_texture, 
    ...
    player_animation_assets.map.insert(AnimationType::Hit, (
            texture_atlas_layouts.add(run_atlas_layout), 
            run_texture, 
